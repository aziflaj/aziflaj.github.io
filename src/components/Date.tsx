...
const FormattedDate = ({ pubDatetime, modDatetime }: DatetimesProps) => {
  const pubDate = typeof pubDatetime === "string" ? new Date(pubDatetime) : pubDatetime;
  const modDate = modDatetime ? (typeof modDatetime === "string" ? new Date(modDatetime) : modDatetime) : null;
